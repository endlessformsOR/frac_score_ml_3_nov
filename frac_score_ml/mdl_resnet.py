...
import keras
from ml_utils import load_ml_data_pops, dynamic_model, evaluate_model, get_train_test_2d_cnn_new
import os
import time
...
model_name = 'resNet_20_msec_3Nov2020'

# 9/24 - New dataset, higher std_m

# std_m = 12
# open file 5618 pops, 875 MB
# 4343 nonevents, filesize is 676 MB

# pops_file_name = 'raw_ml_data/millisecond_data_pops_11oct2020.npy'

pops_file_name = 'raw_ml_data/conditioned_pops_20_msec.npy'
...
x_train, x_test, y_train, y_test = get_train_test_2d_cnn_new(pops_file_name,
                                                             non_pops_file_name,
                                                             window_size_seconds,
                                                             train_test_split_percent
                                                             )
...
# show 10 random testing/training elements
