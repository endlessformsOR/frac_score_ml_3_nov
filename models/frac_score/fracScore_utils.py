...
#
#
from utils.dynamic_utils import interval_to_flat_array, parse_time_string_with_colon_offset
from utils.usefulmethods import dynamic2dashboard, fetch_sensor_db_data, logFFT, logFFT2Dmatrix, Welch_matrix_methods, quickFFTobjs, parse_time_string_with_colon_offset, mkDataTimeFromStr,dtObj2str
                    ...
                    if len(x_d) > 0:
                        ...
                        for pk in peaks_bp:
                            ...
                            if pk > 0.01*sampling_rate:
                                ...
                                x_d_win = interval_to_flat_array(dynID,window_start,window_stop).values()
